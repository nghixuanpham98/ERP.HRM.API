    ...
    public partial class InitIdentitySchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Users__3214EC078EACC68D", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Departme__B2079BED6739090C", x => x.DepartmentId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Position__60BB9A7967EFCAD1", x => x.PositionId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseSalary = table.Column<decimal>(type: "decimal(18,2)", nullable: true, defaultValue: 0m),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Employee__7AD04F11318FD90B", x => x.EmployeeId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Users__536C85E4BDC76937",
                table: "AspNetUsers",
                column: "UserName",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Departme__6EA8896DA18388CE",
                table: "Departments",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Position__83745B02724EC467",
                table: "Positions",
                column: "PositionCode",
                unique: true);
        }
