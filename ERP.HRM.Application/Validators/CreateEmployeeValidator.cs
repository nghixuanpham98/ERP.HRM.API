    ...
    public class CreateEmployeeValidator : AbstractValidator<CreateEmployeeDto>
    {
        public CreateEmployeeValidator()
        {
            ...
            RuleFor(x => x.NationalId)
                .MaximumLength(50).WithMessage("CMND/Căn cước không được vượt quá 50 ký tự")
                .Matches(@"^\d{9,12}$").When(x => !string.IsNullOrEmpty(x.NationalId))
                .WithMessage("CMND/Căn cước phải có 9 đến 12 chữ số");
